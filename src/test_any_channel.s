* Accept ANY channel interrupt and write character
* This will help us understand if the channel check is the problem
...
.WAIT_INT:
        ...
        * Don't check channel - just write character!
        MOVE.B  D0,(CyTDR,A0)
